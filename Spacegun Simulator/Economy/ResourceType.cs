namespace Spacegun_Simulator.Economy
{
    ...
    public static class ResourceTypeHelper
    {
        ...
        public static double GetBaseProductionRate(ResourceType resource)
        {
            return resource switch
            {
                ResourceType.Steel => global::Spacegun_Simulator.Core.GameConstants.SteelProductionPerYear,
                ResourceType.Budget => global::Spacegun_Simulator.Core.GameConstants.BudgetProductionPerYear,
                ResourceType.PowerCells => global::Spacegun_Simulator.Core.GameConstants.PowerCellsProductionPerYear,
                ResourceType.SpecializedAlloys => global::Spacegun_Simulator.Core.GameConstants.SpecializedAlloysProductionPerYear,
                ResourceType.RareEarthElements => global::Spacegun_Simulator.Core.GameConstants.RareEarthElementsProductionPerYear,
                ResourceType.ExoticMaterials => global::Spacegun_Simulator.Core.GameConstants.ExoticProductionPerYear,
                ResourceType.AdvancedOre => global::Spacegun_Simulator.Core.GameConstants.ExoticProductionPerYear * 0.8,  // Slightly less than exotic
                _ => 0
            };
        }
    }
