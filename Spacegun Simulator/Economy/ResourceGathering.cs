namespace Spacegun_Simulator.Economy
{
    ...
    public class ResourceGathering
    {
        ...
        public static double GetEffectiveProductionRate(
            ...
            global::Spacegun_Simulator.Development.Technology.TechTree techTree,
            global::Spacegun_Simulator.Core.GameDifficulty difficulty,
        ...
        /// </summary>
        public static double GetDifficultyMultiplier(global::Spacegun_Simulator.Core.GameDifficulty difficulty)
        {
            return difficulty switch
            {
                global::Spacegun_Simulator.Core.GameDifficulty.NuclearOption => 1.0,           // Easy - full production
                global::Spacegun_Simulator.Core.GameDifficulty.CometsAndAsteroids => 0.85,     // Normal - slight penalty
                global::Spacegun_Simulator.Core.GameDifficulty.RealSpacegunSimulator => 0.70,  // Hard - significant penalty (changed from AlienInvasion)
                _ => 0.85
            };
        }
